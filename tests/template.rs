...
mod context_search {
    use super::{compile_str, render_data};
...
fn test_render_partial_dot_filename() {
    let template =
        mustache::compile_path("tests/test-data/base.foo.mustache").expect("Failed to compile");
